...
export type BasicUser = {
  ...
  job_applications?: Maybe<Array<Maybe<JobsApplications>>>;
};


export type BasicUserJob_ApplicationsArgs = {
...
export type BasicUserInput = {
  ...
  job_applications?: Maybe<Array<Maybe<Scalars['ID']>>>;
...
export type JobsApplicationsConnectionBasic_User = {
  __typename?: 'JobsApplicationsConnectionBasic_user';
  key?: Maybe<Scalars['ID']>;
...
export type JobsApplicationsGroupBy = {
  ...
  basic_user?: Maybe<Array<Maybe<JobsApplicationsConnectionBasic_User>>>;
...
export type Morph = UsersPermissionsMe | UsersPermissionsMeRole | UsersPermissionsLoginPayload | UserPermissionsPasswordPayload | BasicUser | BasicUserConnection | BasicUserAggregator | BasicUserGroupBy | BasicUserConnectionId | BasicUserConnectionCreated_At | BasicUserConnectionUpdated_At | BasicUserConnectionProfile | BasicUserConnectionOwner | BasicUserConnectionCreated_By | BasicUserConnectionUpdated_By | CreateBasicUserPayload | UpdateBasicUserPayload | DeleteBasicUserPayload | BusinessUser | BusinessUserConnection | BusinessUserAggregator | BusinessUserGroupBy | BusinessUserConnectionId | BusinessUserConnectionCreated_At | BusinessUserConnectionUpdated_At | BusinessUserConnectionRestaurant | BusinessUserConnectionOwner | BusinessUserConnectionCreated_By | BusinessUserConnectionUpdated_By | CreateBusinessUserPayload | UpdateBusinessUserPayload | DeleteBusinessUserPayload | JobsApplications | JobsApplicationsConnection | JobsApplicationsAggregator | JobsApplicationsGroupBy | JobsApplicationsConnectionId | JobsApplicationsConnectionCreated_At | JobsApplicationsConnectionUpdated_At | JobsApplicationsConnectionBasic_User | JobsApplicationsConnectionJob | JobsApplicationsConnectionCreated_By | JobsApplicationsConnectionUpdated_By | CreateJobsApplicationPayload | UpdateJobsApplicationPayload | DeleteJobsApplicationPayload | Jobs | JobsConnection | JobsAggregator | JobsAggregatorSum | JobsAggregatorAvg | JobsAggregatorMin | JobsAggregatorMax | JobsGroupBy | JobsConnectionId | JobsConnectionCreated_At | JobsConnectionUpdated_At | JobsConnectionUid | JobsConnectionType | JobsConnectionRestaurant | JobsConnectionShift_Date | JobsConnectionDescription | JobsConnectionPayPerHour | JobsConnectionPosition | JobsConnectionCreated_By | JobsConnectionUpdated_By | CreateJobPayload | UpdateJobPayload | DeleteJobPayload | Profile | ProfileConnection | ProfileAggregator | ProfileGroupBy | ProfileConnectionId | ProfileConnectionCreated_At | ProfileConnectionUpdated_At | ProfileConnectionName | ProfileConnectionProfileImage | ProfileConnectionCoverImage | ProfileConnectionMessage | ProfileConnectionBio | ProfileConnectionCv | ProfileConnectionInterests | ProfileConnectionBasic_User | ProfileConnectionCreated_By | ProfileConnectionUpdated_By | CreateProfilePayload | UpdateProfilePayload | DeleteProfilePayload | Restaurant | RestaurantConnection | RestaurantAggregator | RestaurantAggregatorSum | RestaurantAggregatorAvg | RestaurantAggregatorMin | RestaurantAggregatorMax | RestaurantGroupBy | RestaurantConnectionId | RestaurantConnectionCreated_At | RestaurantConnectionUpdated_At | RestaurantConnectionLatitude | RestaurantConnectionLongitude | RestaurantConnectionAddress | RestaurantConnectionUid | RestaurantConnectionName | RestaurantConnectionBusiness_User | RestaurantConnectionWebsite | RestaurantConnectionPhone | RestaurantConnectionBio | RestaurantConnectionProfilePic | RestaurantConnectionCreated_By | RestaurantConnectionUpdated_By | CreateRestaurantPayload | UpdateRestaurantPayload | DeleteRestaurantPayload | ShiftDate | ShiftDateConnection | ShiftDateAggregator | ShiftDateGroupBy | ShiftDateConnectionId | ShiftDateConnectionCreated_At | ShiftDateConnectionUpdated_At | ShiftDateConnectionCreated_By | ShiftDateConnectionUpdated_By | CreateShiftDatePayload | UpdateShiftDatePayload | DeleteShiftDatePayload | UploadFile | UploadFileConnection | UploadFileAggregator | UploadFileAggregatorSum | UploadFileAggregatorAvg | UploadFileAggregatorMin | UploadFileAggregatorMax | UploadFileGroupBy | UploadFileConnectionId | UploadFileConnectionCreated_At | UploadFileConnectionUpdated_At | UploadFileConnectionName | UploadFileConnectionAlternativeText | UploadFileConnectionCaption | UploadFileConnectionWidth | UploadFileConnectionHeight | UploadFileConnectionFormats | UploadFileConnectionHash | UploadFileConnectionExt | UploadFileConnectionMime | UploadFileConnectionSize | UploadFileConnectionUrl | UploadFileConnectionPreviewUrl | UploadFileConnectionProvider | UploadFileConnectionProvider_Metadata | UploadFileConnectionCreated_By | UploadFileConnectionUpdated_By | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsRoleConnection | UsersPermissionsRoleAggregator | UsersPermissionsRoleGroupBy | UsersPermissionsRoleConnectionId | UsersPermissionsRoleConnectionName | UsersPermissionsRoleConnectionDescription | UsersPermissionsRoleConnectionType | UsersPermissionsRoleConnectionCreated_By | UsersPermissionsRoleConnectionUpdated_By | CreateRolePayload | UpdateRolePayload | DeleteRolePayload | UsersPermissionsUser | UsersPermissionsUserConnection | UsersPermissionsUserAggregator | UsersPermissionsUserGroupBy | UsersPermissionsUserConnectionId | UsersPermissionsUserConnectionCreated_At | UsersPermissionsUserConnectionUpdated_At | UsersPermissionsUserConnectionUsername | UsersPermissionsUserConnectionEmail | UsersPermissionsUserConnectionProvider | UsersPermissionsUserConnectionConfirmed | UsersPermissionsUserConnectionBlocked | UsersPermissionsUserConnectionRole | UsersPermissionsUserConnectionName | UsersPermissionsUserConnectionBasic_User | UsersPermissionsUserConnectionBusiness_User | UsersPermissionsUserConnectionCreated_By | UsersPermissionsUserConnectionUpdated_By | CreateUserPayload | UpdateUserPayload | DeleteUserPayload | ComponentShiftDateShiftDates;
...
export type Mutation = {
  ...
  jobsApplicationToggle?: Maybe<Scalars['Int']>;
  upload: UploadFile;
...
export type MutationJobsApplicationToggleArgs = {
  input?: Maybe<CreateJobsApplicationInput>;
};
...
export type Query = {
  ...
  hasAppliedToJob?: Maybe<Scalars['Int']>;
...
export type QueryHasAppliedToJobArgs = {
  userid: Scalars['ID'];
  jobid: Scalars['ID'];
};
...
export type UsersPermissionsUserGroupBy = {
  ...
  business_user?: Maybe<Array<Maybe<UsersPermissionsUserConnectionBusiness_User>>>;
